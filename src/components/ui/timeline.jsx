...
export const Timeline = ({
  ...
  return (
    (<div
      className="w-full bg-neutral-950 font-sans md:px-10 text-white "
      ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          ...
          I&apos;ve been working on Some Interesting and Complex projects from the past couple of months. Here&apos;s
